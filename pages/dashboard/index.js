                ...
                <div className="checkout container">
                    ...
                    {data.map((data) => (
                        <div
                            ...
                            key={data._id}>
                            <img
                                src={`${process.env.NEXT_PUBLIC_API_IMAGE}/${data.historyEvent.image.name}`}
                            ...
                            <div className="d-flex flex-column gap-3">
                                ...
                                <div className="d-flex align-items-center gap-3">
                                    ...
                                    <span>
                                        {" "}
                                        {moment(data.historyEvent.date).format(
                                            "HH.MM A"
                                        )}
                                    </span>
                                </div>
                                <div className="d-flex align-items-center gap-3">
                                    ...
                                    />
                                    <span>
                                        {formatDate(data.historyEvent.date)}
                                    </span>
                                </div>
                            </div>
...
export async function getServerSideProps(context) {
    const req = await getData(`/orders`, {}, context.req.cookies.token);
